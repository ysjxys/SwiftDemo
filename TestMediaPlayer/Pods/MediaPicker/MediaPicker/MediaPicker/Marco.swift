...
public func imageFromBundle(imageName: String) -> (UIImage?){
    if let path = Bundle(for: ImagePickerViewController.self).path(forResource: "\(imageName)@2x.png", ofType: nil) {
...
public func showHudWith(targetView: UIView, title: String) {
