...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var window: UIWindow?
    let appKey = "24005125"
    let appSecret = "f9fc6bf7c99324034a599d52a3a2be1c"
    ...
    func initCloudPush() {
        CloudPushSDK.asyncInit(appKey, appSecret: appSecret) { (callBackResult) in
...
//        }
    ...
    func application(_ application: UIApplication, didRegisterForRemoteNotificationsWithDeviceToken deviceToken: Data) {
        CloudPushSDK.registerDevice(deviceToken) { (callBackResult) in
            ...
            if result.success {
                ...
                print("Register deviceToken failed")
            }
        }
    }
    ...
    func registerMessageReceive() {
        NotificationCenter.default.addObserver(self, selector: #selector(onMessageReceived(notification:)), name: NSNotification.Name(rawValue: "CCPDidReceiveMessageNotification"), object: nil)
    }
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "TestAlicloudPush")
